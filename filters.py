...
def create_filters(date=None, start_date=None, end_date=None,
    ...
    to the `date` argument, and represents a filter that select
    close approaches that occured on exactly that given date.
    ...
    to that method. For now, this can be thought of as
