...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        the collections of NEOs and close approaches
        haven't yet been linked - that is, the
        ...
        each NEO has a collection of that NEO's close approaches,
    ...
    def query(self, filters=()):
        ...
        """
        for approach in self._approaches:
            if False not in map(lambda f: f(approach), filters):
                yield approach
